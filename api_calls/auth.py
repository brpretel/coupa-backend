...
from models.schemas.request.user_input_data import UserRegistrationData, UserLoginData


router = APIRouter(prefix="/auth", tags=["auth"], responses={401: {"user": "Not authorized"}})


@router.post("/register", description="Allows to register new users {agents} only")
