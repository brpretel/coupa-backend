...
from schemas.request.case_input_data import CaseStatus
...
case = sqlalchemy.Table(
    ...
    sqlalchemy.Column("case_type", sqlalchemy.String(60), nullable=False),
    ...
    sqlalchemy.Column("salesforce_case_number", sqlalchemy.Integer, nullable=False, unique=True),
