...
user = sqlalchemy.Table(
    ...
    sqlalchemy.Column("user_vertical", sqlalchemy.String(30), nullable=False),
    sqlalchemy.Column("status", sqlalchemy.Enum(UserStatus), nullable=False, server_default=UserStatus.pending.name),
    sqlalchemy.Column("user_role", sqlalchemy.Enum(UserRole), nullable=False, server_default=UserRole.agent.name),
